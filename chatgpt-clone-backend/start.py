...
n_layer = 6
dropout = 0.2
save_path = 'model_weights.pth'  # path to save the model weights
# ------------
...
for iter in range(max_iters):
    ...
    # if validation loss improves, save the model weights
...
response = decode(model.generate(context, max_new_tokens=100)[0].tolist())
